---
title: "Git History Secret Scanning: Detecting Leaked Credentials in Repositories"
slug: "git-history-secret-scanning-detection"
date: "2026-03-04"
author: "BugB Security Team"
authorTitle: "Security Researchers"
excerpt: "Scan Git repository history for leaked API keys tokens and credentials."
...
>
> **Template source:** [`git-history-secret-scan.go`](https://github.com/Bugb-Technologies/cert-x-gen-templates/blob/main/templates/devops/git/git-history-secret-scan.go)
