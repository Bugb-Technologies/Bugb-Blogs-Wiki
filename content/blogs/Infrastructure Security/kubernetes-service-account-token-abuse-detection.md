---
title: "Kubernetes Service Account Token Abuse Detection"
slug: "kubernetes-service-account-token-abuse-detection"
date: "2026-03-04"
author: "BugB Security Team"
authorTitle: "Security Researchers"
excerpt: "Detect Kubernetes service account token misuse from over-privileged tokens to leaked credentials."
...
>
> **Template source:** [`service-account-token-abuse.go`](https://github.com/Bugb-Technologies/cert-x-gen-templates/blob/main/templates/devops/kubernetes/service-account-token-abuse.go)
...
- Identify pods with SA token volume mounts
...
- Escape to underlying node — full infrastructure compromise
